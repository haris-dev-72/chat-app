    ...
    <>
      {!chatView ? (
        ...
        <div className="grid grid-flow-col h-screen">
          <div className="bg-blue-500 p-4 flex flex-col gap-4 ">
            {users &&
              users.map((user: any) => {
                return (
                  <>
                          ...
                          {user.messages &&
                            user.messages.map((message: any) => {
                              return (
                                <>
                                  <div
                                    className={`flex flex-col gap-1 mb-6  rounded-lg ${
                                      message.fromSelf
                                        ? "text-green-900 items-start bg-red-300"
                                        : "text-red-700 items-end bg-green-300"
                                    }`}
                                  >
                                    <div>
                                      {message.fromSelf
